...
public static class Data
{
    ...
    public static readonly Dictionary<Tetromino, Vector2Int[]> Cells = new Dictionary<Tetromino, Vector2Int[]>()
    {
        ...
        { Tetromino.G, new Vector2Int[] { new Vector2Int( 0, 0), new Vector2Int( 0, 0), new Vector2Int( 0, 0), new Vector2Int( 0, 0) } },
        { Tetromino.Q, new Vector2Int[] { new Vector2Int( 0, 0), new Vector2Int( 0, 0), new Vector2Int( 0, 0), new Vector2Int( 0, 0) } },
        { Tetromino.W, new Vector2Int[] { new Vector2Int( 0, 0), new Vector2Int( 0, 0), new Vector2Int( 0, 0), new Vector2Int( 0, 0) } },
        { Tetromino.E, new Vector2Int[] { new Vector2Int( 0, 0), new Vector2Int( 0, 0), new Vector2Int( 0, 0), new Vector2Int( 0, 0) } },
    };
    ...
    public static readonly Dictionary<Tetromino, Vector2Int[,]> WallKicks = new Dictionary<Tetromino, Vector2Int[,]>()
    {
        ...
        { Tetromino.G, WallKicksJLOSTZ },
        { Tetromino.Q, WallKicksJLOSTZ },
        { Tetromino.W, WallKicksJLOSTZ },
        { Tetromino.E, WallKicksJLOSTZ },
    };
}
